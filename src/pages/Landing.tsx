    ...
    <div className="min-h-screen bg-background overflow-hidden">
      ...
      <section className="relative pt-32 pb-32 px-4">
        ...
        <div className="absolute inset-0 pointer-events-none overflow-hidden">
          {[Wallet, QrCode, Gift, Trophy, Store].map((Icon, i) => (
            <motion.div
              key={i}
      ...
      <section className="py-20 px-4 relative">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            {[
              { icon: <Lock className="w-5 h-5" />, title: 'Secure Transactions', desc: 'All wallet operations are protected by server-side security functions' },
              { icon: <Shield className="w-5 h-5" />, title: 'Data Protection', desc: 'Row-level security ensures users only access their own data' },
              { icon: <Globe className="w-5 h-5" />, title: 'Real-time Sync', desc: 'Instant balance updates across all devices with conflict resolution' },
              { icon: <Clock className="w-5 h-5" />, title: 'Automatic Expiration', desc: 'Currencies automatically deactivate when events end' },
            ].map((item, i) => (
              <motion.div
                key={i}
        ...
        <div className="max-w-4xl mx-auto">
          ...
          >
            {[
              ...
              { value: '10K+', label: 'Max Participants' },
      ...
      <section className="py-20 px-4 bg-card/30 relative">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-4">
            {[
              'No technical skills required — anyone can create an event economy',
              'Complete customization — your currency, your rules, your branding',
              'Real-time everything — balances, transactions, and analytics update instantly',
              'Secure by design — enterprise-grade protection for every transaction',
              'Automatic cleanup — currencies expire when events end, no loose ends',
              'Gamification built-in — badges and rewards keep participants engaged',
              'Works on any device — no app downloads required, just scan and go',
            ].map((item, i) => (
              <motion.div
                key={i}
      ...
      <footer className="py-8 px-4 border-t border-border">
        <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <p className="text-sm text-muted-foreground">
            2025 Mintly. Create your own event economy.
          </p>
        </div>
      </footer>
    </div>
